...
[source,java]
----
`link:apidocs/examples/Examples.html#example2-io.vertx.core.Vertx-[example2]`
----
...
[source,java]
----
`link:apidocs/examples/Examples.html#example3-io.vertx.core.Vertx-[example3]`
----
...
* [source,java]
----
`link:apidocs/examples/Examples.html#example4-io.vertx.ext.asyncsql.AsyncSqlService-[example4]`
----
