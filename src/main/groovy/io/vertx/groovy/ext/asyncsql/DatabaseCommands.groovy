...
public interface DatabaseCommands {
  ...
  void raw(String command, Handler<AsyncResult<Map<String, Object>>> resultHandler);
  void insert(String table, List<String> fields, List<List<Object>> values, Handler<AsyncResult<Map<String, Object>>> resultHandler);
  void select(String table, Map<String, Object> options, Handler<AsyncResult<Map<String, Object>>> resultHandler);
  void prepared(String statement, List<Object> values, Handler<AsyncResult<Map<String, Object>>> resultHandler);

  static final java.util.function.Function<io.vertx.ext.asyncsql.DatabaseCommands, DatabaseCommands> FACTORY = io.vertx.lang.groovy.Factories.createFactory() {
    io.vertx.ext.asyncsql.DatabaseCommands arg -> new DatabaseCommandsImpl(arg);
  };
}

@CompileStatic
class DatabaseCommandsImpl implements DatabaseCommands {
  final def io.vertx.ext.asyncsql.DatabaseCommands delegate;
  public DatabaseCommandsImpl(io.vertx.ext.asyncsql.DatabaseCommands delegate) {
