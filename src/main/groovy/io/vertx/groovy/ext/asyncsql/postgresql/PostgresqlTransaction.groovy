...
import io.vertx.groovy.ext.asyncsql.TransactionCommands
 ...
 */
@CompileStatic
public class PostgresqlTransaction implements TransactionCommands,  DatabaseCommands {
  final def io.vertx.ext.asyncsql.postgresql.PostgresqlTransaction delegate;
  public PostgresqlTransaction(io.vertx.ext.asyncsql.postgresql.PostgresqlTransaction delegate) {
  ...
  static final java.util.function.Function<io.vertx.ext.asyncsql.postgresql.PostgresqlTransaction, PostgresqlTransaction> FACTORY = io.vertx.lang.groovy.Factories.createFactory() {
    io.vertx.ext.asyncsql.postgresql.PostgresqlTransaction arg -> new PostgresqlTransaction(arg);
  };
}
