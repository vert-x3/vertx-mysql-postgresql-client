...
public class MySQLClient extends AsyncSQLClient {
  ...
  public static AsyncSQLClient createNonShared(Vertx vertx, Map<String, Object> config) {
    def ret= new io.vertx.groovy.ext.asyncsql.AsyncSQLClient(io.vertx.ext.asyncsql.MySQLClient.createNonShared((io.vertx.core.Vertx)vertx.getDelegate(), config != null ? new io.vertx.core.json.JsonObject(config) : null));
    return ret;
  }
  /**
  ...
  public static AsyncSQLClient createShared(Vertx vertx, Map<String, Object> config, String poolName) {
    def ret= new io.vertx.groovy.ext.asyncsql.AsyncSQLClient(io.vertx.ext.asyncsql.MySQLClient.createShared((io.vertx.core.Vertx)vertx.getDelegate(), config != null ? new io.vertx.core.json.JsonObject(config) : null, poolName));
    return ret;
  }
  /**
  ...
  public static AsyncSQLClient createShared(Vertx vertx, Map<String, Object> config) {
    def ret= new io.vertx.groovy.ext.asyncsql.AsyncSQLClient(io.vertx.ext.asyncsql.MySQLClient.createShared((io.vertx.core.Vertx)vertx.getDelegate(), config != null ? new io.vertx.core.json.JsonObject(config) : null));
    return ret;
  }
}
