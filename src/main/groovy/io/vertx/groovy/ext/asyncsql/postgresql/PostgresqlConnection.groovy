 ...
 */
@CompileStatic
public class PostgresqlConnection implements ConnectionCommands,  DatabaseCommands {
  final def io.vertx.ext.asyncsql.postgresql.PostgresqlConnection delegate;
  public PostgresqlConnection(io.vertx.ext.asyncsql.postgresql.PostgresqlConnection delegate) {
  ...
  static final java.util.function.Function<io.vertx.ext.asyncsql.postgresql.PostgresqlConnection, PostgresqlConnection> FACTORY = io.vertx.lang.groovy.Factories.createFactory() {
    io.vertx.ext.asyncsql.postgresql.PostgresqlConnection arg -> new PostgresqlConnection(arg);
  };
}
