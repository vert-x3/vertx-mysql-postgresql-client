 ...
 */
@CompileStatic
public class MysqlTransaction implements TransactionCommands,  DatabaseCommands {
  final def io.vertx.ext.asyncsql.mysql.MysqlTransaction delegate;
  public MysqlTransaction(io.vertx.ext.asyncsql.mysql.MysqlTransaction delegate) {
  ...
  static final java.util.function.Function<io.vertx.ext.asyncsql.mysql.MysqlTransaction, MysqlTransaction> FACTORY = io.vertx.lang.groovy.Factories.createFactory() {
    io.vertx.ext.asyncsql.mysql.MysqlTransaction arg -> new MysqlTransaction(arg);
  };
}
