...
public class PostgreSQLClient extends AsyncSQLClient {
  ...
  public static AsyncSQLClient createNonShared(Vertx vertx, Context context, JsonObject config) { 
    AsyncSQLClient ret= AsyncSQLClient.newInstance(io.vertx.ext.asyncsql.PostgreSQLClient.createNonShared((io.vertx.core.Vertx) vertx.getDelegate(), (io.vertx.core.Context) context.getDelegate(), config));
    return ret;
  }
  ...
  public static AsyncSQLClient createShared(Vertx vertx, Context context, JsonObject config, String poolName) { 
    AsyncSQLClient ret= AsyncSQLClient.newInstance(io.vertx.ext.asyncsql.PostgreSQLClient.createShared((io.vertx.core.Vertx) vertx.getDelegate(), (io.vertx.core.Context) context.getDelegate(), config, poolName));
    return ret;
  }
  ...
  public static AsyncSQLClient createShared(Vertx vertx, Context context, JsonObject config) { 
    AsyncSQLClient ret= AsyncSQLClient.newInstance(io.vertx.ext.asyncsql.PostgreSQLClient.createShared((io.vertx.core.Vertx) vertx.getDelegate(), (io.vertx.core.Context) context.getDelegate(), config));
    return ret;
  }

  /**
   * Like {@link io.vertx.rxjava.ext.asyncsql.PostgreSQLClient#createShared} but with the default pool name. It uses the
   *  retrieved using .
   * @param vertx the Vert.x instance
   * @param config the configuration
   * @return the client
