...
*/
public class PostgresqlConnectionVertxProxyHandler extends ProxyHandler {

  private final Vertx vertx;
  private final PostgresqlConnection service;
  private final String address;

  public PostgresqlConnectionVertxProxyHandler(Vertx vertx, PostgresqlConnection service, String address) {
    this.vertx = vertx;
