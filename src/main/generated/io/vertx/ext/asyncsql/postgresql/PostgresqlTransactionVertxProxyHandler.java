...
*/
public class PostgresqlTransactionVertxProxyHandler extends ProxyHandler {

  private final Vertx vertx;
  private final PostgresqlTransaction service;
  private final String address;

  public PostgresqlTransactionVertxProxyHandler(Vertx vertx, PostgresqlTransaction service, String address) {
    this.vertx = vertx;
