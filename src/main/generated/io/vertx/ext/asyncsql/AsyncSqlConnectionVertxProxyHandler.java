...
*/
public class AsyncSqlConnectionVertxProxyHandler extends ProxyHandler {

  private final Vertx vertx;
  private final AsyncSqlConnection service;
  private final String address;

  public AsyncSqlConnectionVertxProxyHandler(Vertx vertx, AsyncSqlConnection service, String address) {
    this.vertx = vertx;
