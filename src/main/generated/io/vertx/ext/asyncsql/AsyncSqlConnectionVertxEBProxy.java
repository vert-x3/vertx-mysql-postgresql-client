...
public class AsyncSqlConnectionVertxEBProxy implements AsyncSqlConnection {
  ...
  public AsyncSqlConnection query(String sql, JsonArray params, Handler<AsyncResult<ResultSet>> resultHandler) {
    if (closed) {
      resultHandler.handle(Future.failedFuture(new IllegalStateException("Proxy is closed")));
      return this;
    }
  ...
  public AsyncSqlConnection update(String sql, JsonArray params, Handler<AsyncResult<UpdateResult>> resultHandler) {
    if (closed) {
      resultHandler.handle(Future.failedFuture(new IllegalStateException("Proxy is closed")));
      return this;
    }
