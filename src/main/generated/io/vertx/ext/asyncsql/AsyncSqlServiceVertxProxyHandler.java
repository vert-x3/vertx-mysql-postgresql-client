...
public class AsyncSqlServiceVertxProxyHandler extends ProxyHandler {
  ...
  public AsyncSqlServiceVertxProxyHandler(Vertx vertx, AsyncSqlService service, String address) {
    this.vertx = vertx;
      ...
      case "getConnection": {
        service.getConnection(res -> {
          if (res.failed()) {
            ...
            ProxyHelper.registerService(AsyncSqlConnection.class, vertx, res.result(), proxyAddress);
