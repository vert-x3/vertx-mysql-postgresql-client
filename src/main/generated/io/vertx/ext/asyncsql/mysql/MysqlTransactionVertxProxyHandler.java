...
*/
public class MysqlTransactionVertxProxyHandler extends ProxyHandler {

  private final Vertx vertx;
  private final MysqlTransaction service;
  private final String address;

  public MysqlTransactionVertxProxyHandler(Vertx vertx, MysqlTransaction service, String address) {
    this.vertx = vertx;
