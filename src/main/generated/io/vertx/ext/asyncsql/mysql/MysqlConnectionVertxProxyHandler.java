...
*/
public class MysqlConnectionVertxProxyHandler extends ProxyHandler {

  private final Vertx vertx;
  private final MysqlConnection service;
  private final String address;

  public MysqlConnectionVertxProxyHandler(Vertx vertx, MysqlConnection service, String address) {
    this.vertx = vertx;
