 ...
 */
MySQLClient.createNonShared = function() {
  var __args = arguments;
  if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'object') {
    return utils.convReturnVertxGen(JMySQLClient["createNonShared(io.vertx.core.Vertx,io.vertx.core.json.JsonObject)"](__args[0]._jdel, utils.convParamJsonObject(__args[1])), AsyncSQLClient);
    ...
    return utils.convReturnVertxGen(JMySQLClient["createNonShared(io.vertx.core.Vertx,io.vertx.core.Context,io.vertx.core.json.JsonObject)"](__args[0]._jdel, __args[1]._jdel, utils.convParamJsonObject(__args[2])), AsyncSQLClient);
...
MySQLClient.createShared = function() {
  ...
  if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'object') {
    ...
    return utils.convReturnVertxGen(JMySQLClient["createShared(io.vertx.core.Vertx,io.vertx.core.Context,io.vertx.core.json.JsonObject)"](__args[0]._jdel, __args[1]._jdel, utils.convParamJsonObject(__args[2])), AsyncSQLClient);
    ...
    return utils.convReturnVertxGen(JMySQLClient["createShared(io.vertx.core.Vertx,io.vertx.core.Context,io.vertx.core.json.JsonObject,java.lang.String)"](__args[0]._jdel, __args[1]._jdel, utils.convParamJsonObject(__args[2]), __args[3]), AsyncSQLClient);
  } else utils.invalidArgs();
};
