...
/** @module vertx-mysql-postgresql-js/postgresql_connection */
...
var JPostgresqlConnection = io.vertx.ext.asyncsql.postgresql.PostgresqlConnection;
...
/**
 ...
 @class
*/
var PostgresqlConnection = function(j_val) {

  var j_postgresqlConnection = j_val;
  var that = this;
  ...
  this.raw = function(command, resultHandler) {
    ...
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
      j_postgresqlConnection.raw(command, function(ar) {
      if (ar.succeeded()) {
  ...
  this.insert = function(table, fields, values, resultHandler) {
    ...
    if (__args.length === 4 && typeof __args[0] === 'string' && typeof __args[1] === 'object' && __args[1] instanceof Array && typeof __args[2] === 'object' && __args[2] instanceof Array && typeof __args[3] === 'function') {
      j_postgresqlConnection.insert(table, fields, utils.convParamListJsonArray(values), function(ar) {
      if (ar.succeeded()) {
        resultHandler(utils.convReturnJson(ar.result()), null);
      } else {
        resultHandler(null, ar.cause());
  ...
  this.select = function(table, options, resultHandler) {
    ...
    if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] === 'object' && typeof __args[2] === 'function') {
      j_postgresqlConnection.select(table, options != null ? new SelectOptions(new JsonObject(JSON.stringify(options))) : null, function(ar) {
      if (ar.succeeded()) {
        resultHandler(utils.convReturnJson(ar.result()), null);
      } else {
        resultHandler(null, ar.cause());
  ...
  this.prepared = function(statement, values, resultHandler) {
    ...
    if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] === 'object' && __args[1] instanceof Array && typeof __args[2] === 'function') {
      j_postgresqlConnection.prepared(statement, utils.convParamJsonArray(values), function(ar) {
      if (ar.succeeded()) {
        resultHandler(utils.convReturnJson(ar.result()), null);
      } else {
        resultHandler(null, ar.cause());
  ...
  this.startTransaction = function(handler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_postgresqlConnection.startTransaction(function(ar) {
      if (ar.succeeded()) {
        handler(null, null);
      } else {
  ...
  this.commit = function(resultHandler) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_postgresqlConnection.commit(function(ar) {
      if (ar.succeeded()) {
  ...
  this.rollback = function(resultHandler) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_postgresqlConnection.rollback(function(ar) {
      if (ar.succeeded()) {
        resultHandler(null, null);
      } else {
        resultHandler(null, ar.cause());
  ...
  this.close = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_postgresqlConnection.close(function(ar) {
      if (ar.succeeded()) {
        handler(null, null);
      } else {
        handler(null, ar.cause());
  ...
  this._jdel = j_postgresqlConnection;
};
