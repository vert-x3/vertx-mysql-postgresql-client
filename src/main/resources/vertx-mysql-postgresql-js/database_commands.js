...
/** @module vertx-mysql-postgresql-js/database_commands */
var utils = require('vertx-js/util/utils');

var io = Packages.io;
var JsonObject = io.vertx.core.json.JsonObject;
var JDatabaseCommands = io.vertx.ext.asyncsql.DatabaseCommands;
...
/**
 ...
 @class
*/
var DatabaseCommands = function(j_val) {

  var j_databaseCommands = j_val;
  var that = this;
  ...
  this.raw = function(command, resultHandler) {
    ...
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
      j_databaseCommands.raw(command, function(ar) {
      if (ar.succeeded()) {
  ...
  this.insert = function(table, fields, values, resultHandler) {
    ...
    if (__args.length === 4 && typeof __args[0] === 'string' && typeof __args[1] === 'object' && __args[1] instanceof Array && typeof __args[2] === 'object' && __args[2] instanceof Array && typeof __args[3] === 'function') {
      j_databaseCommands.insert(table, fields, utils.convParamListJsonArray(values), function(ar) {
      if (ar.succeeded()) {
        resultHandler(utils.convReturnJson(ar.result()), null);
      } else {
        resultHandler(null, ar.cause());
  ...
  this.select = function(table, options, resultHandler) {
    ...
    if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] === 'object' && typeof __args[2] === 'function') {
      j_databaseCommands.select(table, options != null ? new SelectOptions(new JsonObject(JSON.stringify(options))) : null, function(ar) {
      if (ar.succeeded()) {
        resultHandler(utils.convReturnJson(ar.result()), null);
      } else {
        resultHandler(null, ar.cause());
  ...
  this.prepared = function(statement, values, resultHandler) {
    ...
    if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] === 'object' && __args[1] instanceof Array && typeof __args[2] === 'function') {
      j_databaseCommands.prepared(statement, utils.convParamJsonArray(values), function(ar) {
      if (ar.succeeded()) {
        resultHandler(utils.convReturnJson(ar.result()), null);
      } else {
        resultHandler(null, ar.cause());
